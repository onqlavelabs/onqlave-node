...
var Encryption = /** @class */ (function () {
    function Encryption() {
        ...
        var keyManager = NewKeyManager(options, randomService, idService);
        var aeadGcmKeyFactory = NewAEADGCMKeyFactory(idService, randomService);
        var xchachaKeyFactory = NewXChaCha20Poly1305KeyFactory(idService, randomService);
        var operations = (_a = {},
            ...
            _a[Algorithms.XChacha20poly1305] = NewXChaCha20Poly1305KeyOperation(xchachaKeyFactory),
            _a);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw OnqlaveError.newOnqlaveErrorWrapf(ErrorCodes.Server, error_2, "[onqlave] SDK: ".concat(operation, " - Failed decrypting cipher data"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        error_4 = _a.sent();
                        throw OnqlaveError.newOnqlaveErrorWrapf(ErrorCodes.Server, error_4, "[onqlave] SDK: ".concat(operation, " - Failed decrypting cipher data"));
                    case 6: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        error_5 = _b.sent();
                        throw OnqlaveError.newOnqlaveErrorWrapf(ErrorCodes.Server, error_5, "[onqlave] SDK: ".concat(operation, " - Failed encrypting plain data"));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_6 = _a.sent();
                        throw OnqlaveError.newOnqlaveErrorWrapf(ErrorCodes.Server, error_6, "[onqlave] SDK: ".concat(operation, " - Failed encrypting plain data"));
                    case 5: return [2 /*return*/];
                }
            });
        });
