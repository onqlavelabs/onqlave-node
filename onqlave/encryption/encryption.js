 ...
 * @typedef {import('stream').Readable} InputStream
 * @typedef {import('stream').Writable} OutputStream
 */
class Encryption {
    /**
     *
    ...
    /**
     *
     * @param plainStream {InputStream}
     * @param cipherStream {OutputStream}
    ...
    /**
     *
     * @param cipherStream {InputStream}
     * @param plainStream {OutputStream}
     * @param associatedData {Uint8Array | Buffer}
     * @returns {Promise<void>}
     */
